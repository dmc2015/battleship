...
#
# # dorothy = Ship.create(name:"Dorothy", sunk?: "null")
# # dorothy = Ship.create(name:"dorothy", sunk?: "false", ship_size: 5)
#
#
# all_ships.each do |ship|
#   all_oceans.each do |oceans|
#
#   x = rand(0..oceans.size - ship.ship_size)
#   y = rand(0..oceans.size - ship.ship_size)
#   #binding.pry
# end
#
#
...
# def assign_to_cells
  ...
  # def ships_location(*array)
  #   cells_x = [array]#short term fix for border, change to 4 & 5
  #   cells_y = [array]#short term fix for border, change to 4 & 5
  #   cells_array = []
  #   random_selection = []
  #
  #   cells_x.each do |x|
